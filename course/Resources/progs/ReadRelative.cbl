...
*>                        made 50 chars to fit on screen.
...
*> Read type : Direct read = 1, Sequential read = 2 --> 2
...
*> Read type : Direct read = 1, Sequential read = 2 --> 1
*> Enter supplier code key (2 digits) --> 05
*>   05  YACHTING MONTHLY      TREE HOUSE, LONDON, ENGLAND                       
